...
class HorariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post horarios_url, params: { horario: { aula_id: @horario.aula_id, clase_id: @horario.clase_id, fin: @horario.fin, inicio: @horario.inicio, tutoria_id: @horario.tutoria_id } }
    end
  ...
  test "should update horario" do
    patch horario_url(@horario), params: { horario: { aula_id: @horario.aula_id, clase_id: @horario.clase_id, fin: @horario.fin, inicio: @horario.inicio, tutoria_id: @horario.tutoria_id } }
